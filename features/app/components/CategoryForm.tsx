...
export function CategoryForm({ t, locale, mode = "main", categories, current, userRole, onCancel, onSave }: CategoryFormProps) {
  ...
  const heading = mode === "main" ? (current ? (locale === "ne" ? "मुख्य श्रेणी सम्पादन गर्नुहोस्" : "Edit Main Category") : (locale === "ne" ? "मुख्य श्रेणी थप्नुहोस्" : "Add Main Category")) : (current ? (locale === "ne" ? "उप-श्रेणी सम्पादन गर्नुहोस्" : "Edit Subcategory") : (locale === "ne" ? "उप-श्रेणी थप्नुहोस्" : "Add Subcategory"));
  ...
  return <form className="data-form" onSubmit={onSave}>
    ...
    <label>{locale === "ne" ? "नेपाली नाम" : "Nepali Name"}<input name="name_ne" required defaultValue={current?.name_ne ?? ""} placeholder={locale === "ne" ? "नेपाली क्याटेगोरी नाम" : "Nepali Category Name"} autoComplete="off" /></label>
    <label>{locale === "ne" ? "अंग्रेजी नाम" : "English Name"}<input name="name_en" required defaultValue={current?.name_en ?? ""} placeholder={locale === "ne" ? "अंग्रेजी क्याटेगोरी नाम" : "English Category Name"} autoComplete="off" /></label>
